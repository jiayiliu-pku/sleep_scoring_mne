...
class Annotations(object):
    ...
    **orig_time**
    ...
    def to_data_frame(self, onset):
        ...
        if onset == 'relative':
            dt = 0
            onsets_dt = [o for o in self.onset]
        else:
    ...
    @verbose
    def save(self, fname, *, overwrite=False, onset='relative', verbose=None):
        ...
        if fname.endswith(".txt"):
            ...
            _write_annotations_csv(fname, self, onset)
        else:
...
def _write_annotations_csv(fname, annot, onset):
    # Modified by Jiayi, 2022/1/24
    annot = annot.to_data_frame(onset)
