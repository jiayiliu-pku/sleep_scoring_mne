...
class MNEBrowseFigure(BrowserBase, MNEFigure):
    ...
    def _keypress(self, event):
        ...
        # scroll left/right
            ...
            if self.mne.is_epochs:
                ...
                denom = 4 if key.startswith('shift') else 1
    ...
    def _sleep_scoring(self, text):
        ...
        duration = 0.1
        _merge_annotations(onset, onset + duration, text,
                            self.mne.inst.annotations, sleep_scoring=True)
